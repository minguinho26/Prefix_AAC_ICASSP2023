...
class tokenizer_Clotho() :
    ...
    def encode(self, sentence) :
        ...
        if self.vocab_size == 7025 :
            sentence += '.'
        elif self.vocab_size == 4368 :
        ...
        for word in word_list : 
            ...
            if self.vocab_size == 4373 and temp_word[-1] == ',' :
    ...
    def __init__(self, vocab_size) :
        ...
        elif vocab_size == 7025 :
            file_path = './Clotho/Clotho_vocabulary_7025.pickle'
        elif vocab_size == 4368 :
            ...
            for i in range(5) :
                ...
                if split == 'development' :
                    ...
                    if tokenizer.vocab_size == 4368 :
                        ...
                        caption = caption.strip()
                    elif tokenizer.vocab_size == 7025 :
                        caption += '.'
