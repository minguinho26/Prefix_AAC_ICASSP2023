...
class AudioCaps_Dataset(Dataset):
    def __init__(self, data_dir, split, prefix_size, vocab_size) :  # split = 'train' or 'test'
...
def dataloader_AudioCapsDataset(data_dir, batch_size, split, prefix_size, vocab_size, is_TrainDataset = False) :
    
    dataset = AudioCaps_Dataset(data_dir, split, prefix_size, vocab_size)
