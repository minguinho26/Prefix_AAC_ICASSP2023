...
#                     next_tokens_source = next_tokens // scores_sum.shape[1]
    ...
    def __init__(self, audio_encoder, tokenizer, encoder_freeze = True, decoder_freeze = True, 
        ...
        self.language_header = nn.Linear(768, vocab_size, bias=False) # vocab_size : 사용하는 vocab의 크기
...
def get_ClipCap_AAC(tokenizer, vocab_size, mapping_type = 'MLP', 
                    prefix_size_dict = {"audio_prefix_size" : 10, "semantic_prefix_size" : 10}, 
                    transformer_num_layers = None, encoder_freeze = True, decoder_freeze = True, pretrain_fromAudioCaps = False) :
    ...
    model = ClipCap_AAC(audio_encoder, tokenizer, encoder_freeze, decoder_freeze, vocab_size, prefix_size_dict = prefix_size_dict, audio_num_layers = audio_num_layers, semantic_num_layers = semantic_num_layers, mapping_type = mapping_type, pretrain_fromAudioCaps = pretrain_fromAudioCaps)
